import pygame, os, sys, menus

import pauseMenu, person1, car1, tank1, jet1, space1, ending, credits
...
def load(gameStates):
    ...
    #Init the menu
    menuState = menus.Menu(gameStates, background=menuBackgroundSurface)
